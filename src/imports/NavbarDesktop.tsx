import svgPaths from "./svg-3lupgtem0l";
...
export default function NavbarDesktop() {
  return (
    <div className="bg-[rgba(255,255,255,0)] relative size-full" data-name="navbar - desktop">
      <div className="max-w-[inherit] size-full">
        <div className="content-stretch flex items-start justify-between max-w-[inherit] px-[100px] py-[10px] relative size-full">
