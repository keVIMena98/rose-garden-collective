import svgPaths from "./svg-p81vr64pkf";
...
function CardBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="aspect-[392/630] relative rounded-[100px] shrink-0 w-full">
...
export default function ServicesMobile() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Services • Mobile">
      ...
      <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Header">
        ...
        <div className="[grid-area:1_/_1] content-stretch flex flex-col h-[84px] items-center justify-center ml-0 mt-0 px-[30px] py-0 relative w-[390px]" data-name="Navbar">
          <div className="content-stretch flex h-[64px] items-center justify-between relative shrink-0 w-[330px]" data-name="Container">
        ...
        <div className="[grid-area:1_/_1] content-stretch flex flex-col items-center max-w-[1280px] ml-0 mt-[767px] relative w-[390px]" data-name="Container">
          <div className="content-stretch flex flex-col items-center max-w-[768px] relative shrink-0" data-name="Column">
            <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Content">
              <p className="font-['Groovy_Font:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[64px] text-center text-white w-full">OUR SERVICES</p>
            </div>
          </div>
        </div>
      </div>
      <BackgroundImage1 additionalClassNames="h-[844px]">
        <div className="content-stretch flex flex-col items-center px-[20px] py-[64px] relative size-full">
          <div className="basis-0 content-stretch flex flex-col grow items-center max-w-[1280px] min-h-px min-w-px relative shrink-0 w-full" data-name="Container">
            <div className="basis-0 grow min-h-px min-w-px relative rounded-[10px] shrink-0 w-full" data-name="Placeholder Lightbox">
      ...
      <div className="content-stretch flex flex-col h-[2118px] items-center overflow-clip px-[30px] py-[64px] relative shrink-0 w-[390px]" data-name="Layout / 423 /">
        <div className="content-stretch flex flex-col gap-[48px] items-center max-w-[1280px] relative shrink-0 w-full" data-name="Container">
          <div className="content-stretch flex flex-col gap-[12px] items-center max-w-[768px] relative shrink-0 w-full" data-name="Section Title">
            <div className="content-stretch flex items-center relative shrink-0" data-name="Tagline Wrapper">
              <p className="font-['Poppins:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">Services</p>
            </div>
            <div className="content-stretch flex flex-col gap-[20px] items-start not-italic relative shrink-0 text-black text-center w-full" data-name="Content">
              <p className="font-['Groovy_Font:Regular',sans-serif] leading-[1.2] relative shrink-0 text-[48px] w-full">Explore Our Service Offerings</p>
              <p className="font-['Poppins:SemiBold',sans-serif] leading-[1.5] relative shrink-0 text-[14px] w-full">We meet people where they are, not where we think they should be.</p>
            </div>
          </div>
          <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip relative shrink-0 w-full" data-name="Card container">
            <div className="aspect-[392/630] relative rounded-[100px] shrink-0 w-full" data-name="Card">
              <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
            ...
            <div className="content-stretch flex flex-col gap-[24px] h-[308px] items-center max-w-[768px] relative shrink-0 w-full" data-name="Column">
              <div className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 w-full" data-name="Content">
                <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading">
                  <p className="font-['Groovy_Font:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[48px] text-black text-center w-full">Your healing journey Starts here now</p>
                </div>
                <p className="font-['Poppins:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-black text-center w-full">Transform your life through mindful practices that honor your unique path of recovery and growth.</p>
              </div>
              <div className="content-stretch flex items-start relative shrink-0" data-name="Actions">
                <div className="bg-[#007566] content-stretch flex items-start px-[20px] py-[16px] relative rounded-[60px] shrink-0" data-name="menu item">
                  <p className="font-['Poppins:Bold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[14px] text-nowrap text-white">Book now</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="content-stretch flex flex-col h-[844px] items-center overflow-clip px-[30px] py-0 relative shrink-0 w-[390px]" data-name="Footer Image">
        ...
        <div className="absolute flex h-[213.19px] items-center justify-center left-[-59px] top-[-35px] w-[202.478px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        ...
        <div className="absolute flex h-[221.896px] items-center justify-center left-[calc(50%+42px)] top-[96px] w-[214.061px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
